...
<!-- <i>We tackle fundamental questions in ecology, including...</i> -->
...
<a href="research.qmd" style="color:inherit" class="text-decoration-none"><i>Check our research {{< iconify ph arrow-right-bold >}}</i></a>
...
<h3>We are motivated to address---and provide solutions for---major challenges at the <i>biodiversity-climate nexus</i></h3>

<button class="btn btn-light" type="button">

<a href="blog.qmd" style="color:inherit" class="text-decoration-none"><i>Read our blog {{< iconify ph arrow-right-bold >}}</i></a>

</button>

<br> ![Recent Tonkin Lab writing retreat to Westport Field Station. Missing: H. R. Lai, A. McLeod, A. Tabi, I. Reyes-Sainz. Image credit: AJ Gillis](assets/img/retreat3.jpg){.lightbox} <br><br>
...
<a href="people.qmd" style="color:inherit" class="text-decoration-none"><i>Meet the team {{< iconify ph arrow-right-bold >}}</i></a>
...
::: scrolling
**June 2025 » Gabi successfully completes her PhD!** Massive congratulations to Gabrielle Koerich on successfully defending her PhD thesis "Forecasting Antarctic moss distributions: unravelling patterns and dispersal dynamics in a fragmented landscape". Gabi's work has been a monumental effort, with her first chapter published in TREE and a couple more to come soon. Her research will significantly advance our understanding of how Antarctic ecosystems might respond to climate change. Well done, Gabi! Gabi has moved on to a postdoctoral fellowship at EAWAG in Switzerland. You'll be missed, Gabi!

**June 2025 » New paper in TREE on the typology of ecological impacts of biological invasions.** Jono was part of a large collaborative effort to develop a typology of ecological impacts of biological invasions. The paper is now out in Trends in Ecology and Evolution. Led by Laís Carneiro and Franck Courchamp as part of Franck's InvaPact research programme, the typology is designed to help researchers and managers better understand the diverse impacts of invasive species on ecosystems. Find the pdf on the publications page. Or check out the blog post [here](https://predirections.substack.com/p/the-many-faces-of-invasive-species).

**May 2025 » Dani's paper published in Science!** Congratulations Dani! It's a wide-ranging review on the ecological and evolutionary consequences of changing seasonality. In short, seasonality is changing in diverse ways as a result of climate change, but we've likely underestimated the ecological consequences of this due to the way impacts propagate across levels of biological organisation from genes to ecosystems. Check it out! Press release [here](Press%20release:%20https://www.canterbury.ac.nz/news-and-events/news/2025/seasonal-shake-ups-upsetting-natural-processes--study-shows). We've also written a piece on The Conversation [here](https://theconversation.com/earths-seasonal-rhythms-are-changing-putting-species-and-ecosystems-at-risk-257660). Find the pdf on the publications page.

**March 2025 » Christina's paper published in Nature Water!** Congratulations Christina! While reinforcing stopbanks and deepening channels may seem like logical responses to increased flood risk, these approaches often exacerbate long-term vulnerabilities and transfer risk elsewhere. Giving rivers room to move provides a mutually beneficial solution for both people and nature. Not only does widening stopbanks/levees help mitigate flood risk, but we demonstrate widespread ecological co-benefits of doing so. Check it out! We've also written a piece on The Conversation [here](https://theconversation.com/giving-rivers-room-to-move-how-rethinking-flood-management-can-benefit-people-and-nature-251225).

**February 2025 » Gabi submits her PhD!** Woohoo! Congratulations, Gabi! Gabi has submitted a wonderful thesis on modelling moss distributions in Antarctica full of complex, bespoke modelling approaches to overcome the limitations associated with modelling small things in a very big environment.

**January 2025 » Olivia's paper published.** Congrats, Olivia for a great piece of work highlighting the complex interactions between trout, galaxiids, and flow conditions. Untangling this complex relationship is no small feat, requiring lots of intense fieldwork. Find the paper on the publications page.

**December 2024 » Craig Simpkins joins the group.** Welcome Craig! Craig is joining as a postdoctoral fellow to work on forecasting river communities as part of Jono's Te Pūnaha Matatini project.

**November 2024 » Julian Merder joins the group.** Welcome to the group Julian! Julian joins as a Postdoctoral Fellow to work on the Fish Futures research grant in the project Jono and Angus McIntosh lead on trout-galaxiid interactions.

**June 2024 » Jono involved in global collaborative project published in Science.** Jono is excited to be part of a global team that has published a paper in Science on the role of human activities in shaping global patterns of decomposition rates in rivers. Find the paper [here](https://www.science.org/doi/10.1126/science.adn1262) or find the pdf on the publications page.
...
**April 2024 » Anne departs.** We're sorry to see Anne go, but super happy for her to move on to bigger and better things as a research scientist at IGB in Berlin! Congrats, Anne. We'll miss you!
...
<!-- ![](assets/img/vision.png){.lightbox} <br><br> -->
...
<iframe src="https://predirections.substack.com/embed" width="480" height="150" style="border:1px solid #EEE; background:white;" frameborder="0" scrolling="no">

</iframe>

[![](assets/img/predirectionsTall.png){width="50%"}](https://predirections.substack.com)
